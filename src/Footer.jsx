...
const Footer = () => {
   return (
      <footer className="bg-gradient-to-r from-[#4B2E2B] via-[#3B2A1A] to-[#2F1E1A] text-white mt-10">
         ...
         <div className="text-center py-4 text-sm border-t border-gray-600 text-gray-300">
